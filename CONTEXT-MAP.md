...
- [Life Points](./life-points/CONTEXT.md) — a game for recognizing and rewarding a richer, more varied life
...
- **Life Points → Site & Infrastructure / Home Server**: Life Points is an installable PWA hosted on Cloudflare Pages at `lifepoints.mattrandell.com`; its PocketBase backend runs through the Home Server and Cloudflare Tunnel at `lifepoints-api.mattrandell.com`. Backend configuration is versioned in this repo; see [Life Points ADR-0001](./life-points/docs/adr/0001-version-pocketbase-backend-configuration.md).
